...
class SegmentRequest extends FormRequest
{
    ...
    {
        $this->segment_logic = json_decode($this->segment_logic);
        // dd($this->segment_logic);
        // dd($this->method());
        switch($this->method()){
            // case 'GET':
            ...
            case 'POST':
                return [
                    ...
                    'segment_logic' =>['required','array','min:1', new LogicIsSerialized],
            ...
            case 'PUT':
                return [
                    ...
                    'logic' =>['required','array','min:1', new LogicIsSerialized],
